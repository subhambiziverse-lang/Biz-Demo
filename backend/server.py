...
async def llm_match_and_answer(
    ...
    system_msg = (
        ...
        f"  - Write a SHORT, CONVERSATIONAL answer in {lang_name}.\n"
        "  - DEFAULT FORMAT: 1 to 2 short sentences, conversion-focused.\n"
        "    • Lead with a direct Yes/No or the key fact.\n"
        "    • End with a soft micro-CTA when natural (e.g. 'Want me to show you?', 'Should I walk you through it?').\n"
        "    • Example: 'Yes, Biziverse supports GST invoicing with auto HSN lookup. Want me to show you?'\n"
        "  - BULLET FORMAT (use ONLY when listing 3+ distinct features/items):\n"
        "    • Use a single short lead line, then 3-5 bullets prefixed with '• '.\n"
        "    • Each bullet ≤ 8 words. No sub-bullets, no headers.\n"
        "    • Example: 'Biziverse includes:\\n• GST invoicing\\n• Inventory & batch tracking\\n• Multi-branch reports'\n"
        "  - NEVER dump the full KB answer text verbatim — extract & rephrase the essential point only.\n"
        "  - NEVER use markdown headers (##), bold (**), tables, or code fences.\n"
        "  - NEVER use salesy filler ('We are delighted...', 'Our amazing product...').\n"
